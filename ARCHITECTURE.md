...
| `psychometric_core` | posterior-aware structural input gates, CWC within/between OLS, event-time log-rate, Rubin `T` on OLS loadings, and strong-gated latent means |
