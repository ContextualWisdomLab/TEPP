...
| `psychometric_core` | posterior-aware structural input gates, CWC within/between OLS plus the contextual effect, event-time log-rate, irregular already-centered residual lag, Rubin `T` on OLS loadings, and strong-gated latent means |
