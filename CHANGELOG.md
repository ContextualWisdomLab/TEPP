...
- `corpus_split` Unicode canonical identity: NFC/NFD (UAX #15) equivalent document bodies emit `CanonicalEquivalent` leakage links and cannot occupy independent split partitions.
