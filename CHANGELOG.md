...
- `causal_language` identity gate: association, temporal precedence, and document links cannot become causal language; recovered claim kinds match known truth at a higher computed rate than collapsing every claim to identified experimental (ADR 0003/0005).
