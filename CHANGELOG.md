...
- `derived_sensitivity` inheritance: topic, factor, and relation artifacts keep the source sensitivity class; unknown kind codes fail closed; derivation and blanket PII masking cannot declassify to public; inherited classes match known truth at a higher computed rate than a public collapse (ADR 0009).
