...
- `prediction_contradiction` promotion gate: half-open event-time intervals that are disjoint from later-observed evidence cannot be promoted to fact; recovered contradiction flags match known truth at a higher computed rate than promoting every forecast (ADR 0016).
