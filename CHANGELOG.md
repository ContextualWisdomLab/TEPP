...
- Product/technical buyer-gap baseline linking approved product and architecture decisions to live PR, review, check, scientific, security, privacy, operability, and ecosystem evidence; each gap includes a bounded next customer action and exact-head refresh rule.
