...
- Product–technical gap baseline and executable buyer-workflow feature specification at `docs/product-technical-gap-baseline.md`, derived from the approved PRD, technical/architecture contracts, research doctoring, implementation maturity ledger, and the live non-draft PR queue.
