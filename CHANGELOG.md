...
- `psychometric_core` CWC contextual effect: `between − within` is the cluster-mean coefficient under CWC, not the between-cluster slope (Enders & Tofighi, 2007, Table 2, pp. 124–127). Overflow of that subtraction fails closed. This is two-level OLS, not their multilevel maximum-likelihood model.
