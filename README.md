...
crates/tepp_api
crates/psychometric_core  # input gates, CWC/event-time/contextual, irregular residual lag, Rubin T, strong means, Driver Eq. 3 TDPRED/TIPRED maps; not a full ESEM/DSEM estimator
```
