...
| posterior ESEM / longitudinal invariance / DSEM | ADR 0005 | `irregular_time` event-lag spacing on the active PR; remaining ESEM/DSEM fit remains accepted-target | active-PR |
