...
| tenant/purpose/role/lifetime access and identity separation | ADR 0009; Threat Model | `tenant_access` tenant/role/system-time lifetime adapters on the active PR; persistence of grants and live HTTP service remaining | active-PR |
