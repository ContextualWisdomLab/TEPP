...
| Rust numerical authority / CPU `f64` reference | ADR 0001 | current workspace foundation; `checkpoint_authority` checkpoint-versus-estimator gate on the active PR; future estimators | partial |
