...
| evidence-bounded LLM interpretation | ADR 0010/0012; PRD | `interpretation_gateway` evidence-span gate and unsupported-claim rate on the active PR; live orchestration/ablation remaining | active-PR |
