...
| purpose-bound PII handling without blanket masking | ADR 0009; `docs/PRIVACY_DATA_GOVERNANCE.md` | `tepp_api` provider-payload minimization/elevated re-identification and retention/deletion implemented-main; `encrypted_mapping` HMAC envelope active on this PR; persistence/KMS and remaining authorization adapters stay accepted-target | active-PR |
