...
| time-varying cross-classified multiple membership | PRD; ADR 0003 | `membership_core` network on protected main; `membership_target` language/episode/template/department/opportunity-pool identity on the active PR; multilevel estimators remaining | partial |
