...
| versioned service/API contracts and exports | PRD; API contract; ADR 0011/0013 | `tepp_api` analysis-run/export/JSON-LD/GraphML contracts on protected main (PR #21); LineageWeave cutoff-safe temporal-context DTO and loopback POST on active PR #158; production TLS remaining | partial |
