...
| translation is not a state transition | PRD; ADR 0002/0003 | `translation_edge` translation/copy/revision-vs-transition and same-language-is-not-translation gates on the active PR | active-PR |
