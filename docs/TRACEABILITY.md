...
| time-varying cross-classified multiple membership | PRD; ADR 0003 | `membership_core` network and Kish ESS on protected main; nested ICC + cross-classified/multiple-membership refusal (this PR); full multilevel/MMMC/ESEM estimators remaining | partial |
