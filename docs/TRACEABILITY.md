...
| multilingual shared latent semantic space | PRD; ADR 0004 | `measurement_invariance` configural/metric/scalar status and loading RMSE on the active PR; remaining language-profile alignment remains accepted-target | active-PR |
