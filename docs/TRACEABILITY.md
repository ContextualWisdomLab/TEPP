...
| purpose-bound PII handling without blanket masking | ADR 0009; `docs/PRIVACY_DATA_GOVERNANCE.md` | `intake_authorization` grant-presence gate on the active PR; export/provider adapters remaining | partial |
