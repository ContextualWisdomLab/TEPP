...
| versioned service/API contracts and exports | PRD; API contract; ADR 0011/0013 | `tepp_api` analysis-run/export/JSON-LD/GraphML contracts on protected main (PR #21); request-bound terminal result and typed status/read contract active in PR #157; HTTP service remaining accepted-target | partial |
