...
| TRSL-TM temporal/relational topic posterior and backend compatibility | ADR 0012; ADR 0004 | `topic_measurement` ALR coordinates on the active PR; STM backend remaining | partial |
