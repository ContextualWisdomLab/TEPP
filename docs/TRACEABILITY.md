...
| posterior ESEM / longitudinal invariance / DSEM | ADR 0005 | `longitudinal_core` within/between decomposition and component RMSE on the active PR; remaining ESEM/DSEM fit remains accepted-target | active-PR |
