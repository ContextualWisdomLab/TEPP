...
| posterior ESEM / longitudinal invariance / DSEM | ADR 0005 | `psychometric_core` input gates, plausible-value loading recovery, and causal-refusal on the active PR; full ESEM/DSEM estimator remaining | partial |
