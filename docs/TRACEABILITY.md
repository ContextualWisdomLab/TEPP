...
| candidate K statistical/Pareto gates + blinded LLM review | ADR 0012; research | `model_selection` statistical/Pareto `K` gate on the active PR; blinded LLM review and backend comparison remain accepted-target | active-PR |
