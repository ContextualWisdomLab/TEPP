...
| time-varying cross-classified multiple membership | PRD; ADR 0003 | `membership_core` network on protected main; `membership_cutoff` availability filter on the active PR; multilevel estimators remaining | active-PR |
