...
| Posterior ESEM/DSEM input gates | `psychometric_core` | active-PR | construct class + PV loading RMSE | computed loading RMSE + causal refusal | ADR 0005; `docs/research/posterior-esem-input-gates.md` |
