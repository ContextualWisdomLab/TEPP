...
| Unicode NFC/NFD identity | `corpus_split` | accepted-target | canonical-equivalence links on PR #59 | NFC/NFD co-partition + empty/duplicate refusal | UAX #15; ADR 0004; `docs/research/unicode-canonical-identity.md` |
