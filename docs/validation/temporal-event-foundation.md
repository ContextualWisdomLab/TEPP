...
| VRAM budget + CPU fallback | `compute_backend` | active-PR | profile/autotune + OOM fallback | computed weighted-sum RMSE; no live GPU claim | ADR 0006; `docs/research/vram-budget-types.md` |
