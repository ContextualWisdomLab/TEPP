...
| Span-grounded mentions | `event_core` | active-PR | this PR | exact-extent P/R + occupancy RMSE vs whole-document | ADR 0016; `docs/research/span-grounded-mentions.md` |
