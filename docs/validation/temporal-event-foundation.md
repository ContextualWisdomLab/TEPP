...
| Translation is not a state transition | `translation_edge` | accepted-target | active PR | refuse translation/copy/revision-as-transition + same-language-is-not-translation + recovery vs translation collapse | ADR 0002/0003 |
