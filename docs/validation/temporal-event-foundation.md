...
| Operational log/source separation | `operational_log` | active-PR | this PR | raw-source/source-identity/blanket-masking fail-closed rejection; opaque-subject replay recovery vs collapsed action; non-decreasing replay time | ADR 0009 |
