...
| Unidentified association is not causal language | `causal_language` | accepted-target | active PR | refuse association/precedence/link-as-causal + recovery vs experimental collapse | ADR 0003/0005 |
