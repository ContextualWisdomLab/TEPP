...
| Logistic-normal topic coordinates | `topic_measurement` | active-PR | ALR + lexical refusal | true-parameter ALR RMSE | ADR 0012; `docs/research/topic-logratio-coordinates.md` |
