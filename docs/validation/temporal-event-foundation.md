...
| Simulation cutoff eligibility | `tepp_simulation` | active-PR | available ≤ cutoff | delayed-doc exclude + count match | ADR 0002; `docs/research/simulation-cutoff-eligibility.md` |
