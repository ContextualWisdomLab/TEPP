...
| Unicode NFC/NFD identity | `corpus_split` | pending-main (PR #59) | canonical-equivalence links | NFC/NFD co-partition + empty/duplicate refusal | UAX #15; `docs/research/unicode-canonical-identity.md` |
