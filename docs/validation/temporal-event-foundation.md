...
| Allen path-consistency | `temporal_core` | implemented-main | predicted assertions | unit + budget tests; predicted-vs-observed rejection (active PR) | Task 4 / PR #9 + predicted assertions |
