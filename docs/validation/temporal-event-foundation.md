...
| Embedded image source units | `evidence_core` | pending-main (PR #58) | data-URI spans | PNG URI recover + lexical refuse | ADR 0008; `docs/research/embedded-image-units.md` |
