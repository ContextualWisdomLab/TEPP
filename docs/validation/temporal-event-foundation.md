...
| Operational log/source separation | `operational_log` | active-PR | this PR | replayed action recovery vs collapsed action, source-text/source-identity refusal, blanket-mask denial | ADR 0009; `docs/research/operational-log-source-separation.md` |
