...
| Operational log/source separation | `operational_log` + `persistence_postgres` | active-PR | this PR | replayed action recovery vs collapsed action; `audit_event` insert refuses source text | ADR 0009 |
