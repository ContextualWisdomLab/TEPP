...
| Typed membership targets beyond entity/project | `membership_target` | accepted-target | active PR | refuse collapse + recovery vs entity stand-in for language, episode, template, department, and opportunity pool | ADR 0003 |
