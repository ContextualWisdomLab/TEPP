...
| Encrypted identity mapping envelope | `encrypted_mapping` | active-PR | this PR | recovered identity rate vs collapsed names | ADR 0009; persistence waits for later migration |
