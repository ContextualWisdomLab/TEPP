...
| Bitemporal persistence + live SQL port | `persistence_postgres` | partial | audit-event SQL | migration contracts + recording transport + optional PgPool + live CI + tenant RLS + `0005`/`0006` + event relation/mention/instance + source-artifact (#37–#40 implemented-main) + audit action-code validation (active PR) | Task 8 / PR #16 + #23 + #26 + #27 + #29 + #30–#40 + audit-event SQL |
