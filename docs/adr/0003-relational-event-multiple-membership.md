...
**Implementation maturity:** partial — membership network, event mention/instance separation, inferred/evidential/retrospective status gates, typed forward-only relation graph, nested ICC refusal, and subevent parent-window containment are implemented-main; full multilevel/MMMC estimators and remaining persistence remain accepted-target.
**Date:** 2026-08-05
