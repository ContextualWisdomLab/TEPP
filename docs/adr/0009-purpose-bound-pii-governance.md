...
**Implementation maturity:** partial — persistence retention/deletion/legal-hold (migration `0007`) is implemented-main; untrusted-intake grant presence in `intake_authorization` is on the active PR; export/provider adapters remain accepted-target  
**Date:** 2026-08-10  
**Supersedes:** None.
