...
**Implementation maturity:** active-PR — `encrypted_mapping` seals source identity with a keyed `SHA-256` HMAC envelope; persistence/KMS and remaining authorization adapters stay accepted-target  
**Date:** 2026-08-10  
**Supersedes:** None.
