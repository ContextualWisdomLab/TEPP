...
**Implementation maturity:** partial — typed clocks/intervals are implemented-main (PR #8); translation/copy/revision provenance identity is `translation_edge` on the active PR; remaining clock-identity and split enforcement stay accepted-target  
**Date:** 2026-08-05  
