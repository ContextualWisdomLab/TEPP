...
**Implementation maturity:** active-PR — predicted Allen assertions in existing `temporal_core` stay hypothetical and cannot rewrite observed evidence; remaining TDT detection/tracking and CHRONOS schema layers remain accepted-target  
**Date:** 2026-08-12  
