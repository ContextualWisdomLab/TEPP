...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Tenant/role/lifetime adapters in `tenant_access` on the active PR; remaining purpose-grant persistence/export adapters and deployment evidence remain accepted-target. Not a certification claim. |
