...
| [0010](0010-adaptive-llm-orchestration.md) | Adaptive LLM orchestration and test-time compute | Accepted | active-PR | Evidence-bounded interpretation gate in `interpretation_gateway` on the active PR; remaining routing/ablation/live orchestrator remain accepted-target. |
