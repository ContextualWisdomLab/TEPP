...
| [0005](0005-posterior-esem-dsem.md) | Posterior-aware ESEM/DSEM and valid compositional coordinates | Accepted | active-PR | Event-time lag spacing in `irregular_time` on the active PR; remaining ESEM/DSEM fit remains accepted-target. |
