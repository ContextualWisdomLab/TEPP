...
| [0012](0012-temporal-relational-shared-latent-topic-measurement.md) | Temporal Relational Shared-Latent Topic Measurement (TRSL-TM) | Accepted | active-PR | Global topic activity identity in `topic_lineage` on the active PR; remaining topic estimator/backend/global-K contract remains accepted-target. |
