...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | `encrypted_mapping` HMAC envelope on the active PR; persistence/KMS and remaining adapters stay accepted-target. Controls are not a certification claim. |
