...
| [0024](0024-independent-topic-importance-anchor.md) | Posterior topic-context producer contract | Accepted | active-PR | Strict DTO/schema only; the current estimator does not emit it. fast-mlsirm owns case-deletion influence. |
