...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | `operational_log` inspects source text, source identity, and blanket-mask intent on the active PR; persistence, live HTTP, and certification evidence remain accepted-target. |
