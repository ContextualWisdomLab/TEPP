...
| [0004](0004-shared-multilingual-latent-space.md) | One shared multilingual latent space with explicit invariance status | Accepted | active-PR | Estimator-side method-source vocabulary in `method_effects` on the active PR; remaining shared-space alignment remains accepted-target. ADR 0012 owns the full topic-estimator contract. |
