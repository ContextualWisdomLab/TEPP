...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | partial | Provider-payload minimization and elevated re-identification are on the active PR; persistence retention/deletion/legal-hold and deployment evidence remain accepted-target. |
