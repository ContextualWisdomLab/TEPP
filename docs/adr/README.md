...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Re-identification export in `identity_mapping` on the active PR; persistence, live HTTP, and certification evidence remain accepted-target. |
