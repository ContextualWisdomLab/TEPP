...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Operational log/source separation in `operational_log` on the active PR; persistence, live HTTP, and certification evidence remain accepted-target. |
