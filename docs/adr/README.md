...
| [0016](0016-tdt-chronos-event-intelligence-boundary.md) | TDT, CHRONOS, and Event Ontology intelligence boundary | Accepted | active-PR | Predicted Allen assertions in `temporal_core` stay hypothetical; remaining TDT detection/tracking and CHRONOS schema layers remain accepted-target. |
