...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Selective field grants in `selective_disclosure` on the active PR; persistence, live HTTP, encryption, and certification evidence remain accepted-target. |
