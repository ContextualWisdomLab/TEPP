...
| [0006](0006-vram-gpu-nvidia-orchestration.md) | VRAM-adaptive GPU compute and model-credential boundary | Accepted | partial | VRAM budget types, OOM fallback, and CPU `f64` reference are on the active PR; live GPU kernels and hardware parity remain accepted-target. |
