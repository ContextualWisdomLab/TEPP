...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Purpose grants in `purpose_authorization` on the active PR; remaining persistence/export adapters and deployment evidence remain accepted-target. Not a certification claim. |
