...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Provider-disclosure receipts in `provider_receipt` on the active PR; persistence, live HTTP, and certification evidence remain accepted-target. |
