...
| [0009](0009-purpose-bound-pii-governance.md) | Purpose-bound PII governance without blanket masking | Accepted | active-PR | Privileged-access audit replay in `privileged_access` on the active PR; persistence, live HTTP, and certification evidence remain accepted-target. |
