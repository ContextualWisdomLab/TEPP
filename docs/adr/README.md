...
| [0010](0010-adaptive-llm-orchestration.md) | Adaptive LLM orchestration and test-time compute | Accepted | partial | Loopback interpretation listener records mode/budget and refuses scientific-authority promotion; adaptive routing and ablation remain accepted-target. |
| [0011](0011-standalone-modular-msa-boundary.md) | Standalone operation and modular CWL MSA boundary | Accepted | partial | Owns cross-service persistence/credential/API authority; naruon HTTPS interchange implemented-main; orchestrator loopback live HTTP/1.1 listener is on this PR; no direct cross-service application-table coupling. |
