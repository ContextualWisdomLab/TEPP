...
- **active-PR:** PR #97 `prediction_contradiction` Allen coverage gate; `refuse_promotion` requires observed coverage before unmatched predicted mass can become fact. Keep PR #93 and PR #94 draft. Promote only after exact-head gates and merge.
