...
- **active-PR:** `prediction_contradiction` Allen coverage gate; `refuse_promotion` requires observed coverage before unmatched predicted mass can be promoted. Drafts #93, #94, and #97 are historical lineage. Promote only after exact-head gates and merge.
