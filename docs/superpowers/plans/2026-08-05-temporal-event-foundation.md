...
- [x] Update ADRs, architecture, research citations, CHANGELOG, operating limits, rollback, and next-phase interfaces; release only if every protected gate passes. (ledger + doctoring in progress; release still gated)
