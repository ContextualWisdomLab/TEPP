...
- Snapshot facts were fetched live at 2026-08-28T04:47:01Z against protected
...
2026-08-28T04:47:01Z against protected main `b03cc378`. Review decisions,
...
| #281 | `4bf8041c2a200bba3fa6ca5f44a16be4de77b22d` | false | main | docs(gap): refresh protected-main and eight-PR queue |
...
| #285 | `a31f7ff8a5eb9affe2f134636468b830c6e31359` | false | feat/topic-context-producer | fix(topic): bind artifact ids to fitted draw basis |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K` execution and topic-context artifacts remain stacked open-branch candidates on #282/#284/#285 | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) | `2858575ccc84` / `65b2c5f0a0a3` / `a31f7ff8a5eb` | Synchronize the stack and land each PR only after its current-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
