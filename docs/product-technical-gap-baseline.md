...
| --- | --- | --- |
| fast-mlsirm #1717 | `81d3ed2275a785cd3b136f267b208c0d2c166dd3`, open / Ready / mergeable | Post-restack Python source-isolation and buyer-delivery packet integrity repairs are mutable. Exact-head CI/security/CodeQL/Semgrep/fuzz runs are pending/unallocated in a repository-wide Actions backlog; no predecessor GREEN transfers. |
| fast-mlsirm #1816 | `3a1176998103332d26c9fb211fe2bf954dabd428`, open / Draft / mergeable | Correctly rounded finite binary64 mean candidate remains stacked on #1717 and unreleased. Numerical/scientific acceptance must be reacquired after #1717 lands. |
...
The next owner-correct scientific sequence is #1717 exact-head hosted GREEN + qualifying review -> normal protected-main merge -> immutable fast-mlsirm release -> #1816 non-force restack and numerical acceptance -> immutable release -> TEPP #310 consumer bump. TEPP must not short-circuit that sequence by copying static arithmetic or pinning mutable Git heads.
