...
- Snapshot facts were fetched live at 2026-08-28T09:40:30Z against protected
...
2026-08-28T09:40:30Z against protected main `b03cc378`. Review decisions,
...
| #281 | `119a25ca05667b9b897924499354783c52cd7da7` | false | main | docs(gap): refresh protected-main and eight-PR queue |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K`, topic-context artifact, draw-basis binding, and coverage repair are combined on the open #282 feature head through folded PRs #284–#286 | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [folded PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [folded PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) / [folded PR #286](https://github.com/ContextualWisdomLab/TEPP/pull/286) | `46ffba042096` | Land #282 only after its moved-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
...
| [#282](https://github.com/ContextualWisdomLab/TEPP/pull/282) | Fitted candidate-`K` topic selection plus folded #284–#286 topic-context and coverage work (GAP-004) | Complete restarted workflows on exact head `46ffba042096` and obtain qualifying independent approval. |
