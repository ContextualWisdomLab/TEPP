...
- PR #285 merged its fitted draw-basis binding into the open #284 feature
  ...
  #284's moved head requires new exact-head checks and independent review.
- Snapshot facts were fetched live at 2026-08-28T05:19:40Z against protected
...
| Open pull requests | **7** | Active queue: #272 `TIPREDVARstd`, #279 interval consistency, #280 `discreteDRIFTstd`, #281 this baseline refresh, #282 fitted candidate-`K` selection, #283 ADR identity repair, and #284 topic-context artifact assembly with #285 folded into its feature head. |
...
2026-08-28T05:19:40Z against protected main `b03cc378`. Review decisions,
...
| #281 | `83dd983726810ba4b5902b33e2729c32050a17a9` | false | main | docs(gap): refresh protected-main and eight-PR queue |
...
| #284 | `0a3b29e3a79c0f79a951f7101caaa83bfda941a6` | false | feat/topic-lineage-candidate-k | feat(topic): assemble context posterior artifact |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K` execution remains on #282, while #285's draw-basis binding is folded into the open #284 topic-context feature head | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [merged child PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) | `2858575ccc84` / `0a3b29e3a79c` | Land #282 and the moved #284 head only after their current-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
...
4. **Build the CPU topic estimator:** #167 — reference estimator landed; fitted candidate-`K` execution remains on #282, and the topic-context artifact plus #285 draw-basis binding remain an open-branch candidate on #284, while full Bayesian fitting remains.
