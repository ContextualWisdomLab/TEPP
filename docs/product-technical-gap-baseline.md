...
- Snapshot facts were fetched live at 2026-08-28T11:54:24Z against protected
...
2026-08-28T11:54:24Z against protected main `b03cc378`. Review decisions,
...
| #281 | `ca53835972504cdeacafa6eea96c14e36caea307` | false | main | docs(gap): refresh protected-main and ten-PR queue |
...
| #293 | `5109a86641aa36fa5f5c83fb7720cc3919f1c988` | false | feat/interval-consistency-export-persistence | fix(event): bind complete interval artifact authority |
...
| GAP-007 | TDT detection/tracking and CHRONOS schema/forecast/temporal reasoning now compose on protected main, but interval consistency, persistence, and exports are not yet one calibrated operator workflow. | `partial` | product vertical | Versioned TDT/CHRONOS composition merged through [#269](https://github.com/ContextualWisdomLab/TEPP/pull/269) | [#170](https://github.com/ContextualWisdomLab/TEPP/issues/170) / [PR #279](https://github.com/ContextualWisdomLab/TEPP/pull/279) / [PR #291](https://github.com/ContextualWisdomLab/TEPP/pull/291) / [PR #293](https://github.com/ContextualWisdomLab/TEPP/pull/293) | `5109a86641aa` | Land #279/#291, then revalidate #293, which binds complete variable scope and cutoff provenance; versioned JSON-LD export and known-truth workflow recovery remain. |
...
| [#293](https://github.com/ContextualWisdomLab/TEPP/pull/293) | Complete event-inventory and cutoff authority for interval artifacts (GAP-007) | Complete exact-head checks and independent review on `5109a86641aa`; land and revalidate the #279/#291 parent stack first. |
