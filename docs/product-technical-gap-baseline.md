...
- Snapshot facts were fetched live at 2026-08-28T04:30:12Z against protected
...
2026-08-28T04:30:12Z against protected main `b03cc378`. Review decisions,
...
| #281 | `94d65cd4cc5a64a875fe8768b222643e8edecd71` | false | main | docs(gap): refresh protected-main and eight-PR queue |
...
| #284 | `5efb1847b90f3cb30c0f22ae6d90b2fdff0e2306` | false | feat/topic-lineage-candidate-k | feat(topic): assemble context posterior artifact |
| #285 | `18c6275c63dc3928e98c0db5c0ab361601a649aa` | false | feat/topic-context-producer | fix(topic): bind artifact ids to fitted draw basis |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K` execution and topic-context artifacts remain stacked open-branch candidates on #282/#284/#285 | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) | `2858575ccc84` / `5efb1847b90f` / `18c6275c63dc` | Synchronize the stack and land each PR only after its current-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
