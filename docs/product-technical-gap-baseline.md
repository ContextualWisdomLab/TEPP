...
- Snapshot facts were fetched live at 2026-08-28T10:07:54Z against protected
...
| Open pull requests | **7** | Active queue: #272 `TIPREDVARstd`, #279 interval consistency, #280 `discreteDRIFTstd`, #281 this baseline refresh, #282 fitted candidate-`K` selection with #284–#286 folded into its feature head, #283 ADR identity repair, and #287 durable analysis-run persistence. |
...
2026-08-28T10:07:54Z against protected main `b03cc378`. Review decisions,
...
| #281 | `4c9de8444673ed35d4f6cdf85bb7e542e9e551e3` | false | main | docs(gap): track stacked topic delivery |
| #282 | `4edf666d10879952cd8057ea45b8f37ac7bbbacb` | false | fix/unique-adr-identities | feat(topic): execute fitted candidate-K selection |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K`, topic-context artifact, draw-basis binding, and coverage repair are combined on the open #282 feature head through folded PRs #284–#286, stacked on #283 for the shared ADR-identity repair | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [folded PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [folded PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) / [folded PR #286](https://github.com/ContextualWisdomLab/TEPP/pull/286) | `4edf666d1087` | Land #283 first, then revalidate #282 against main with exact-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
...
| GAP-011 | TEPP is not yet an operable multi-tenant service or supported release. | `partial` | product vertical | `e65cd66` (library contracts only); durable tenant-isolated analysis-run requests, append-only state events, and engine-result artifact persistence are an unmerged candidate on #287 | [#174](https://github.com/ContextualWisdomLab/TEPP/issues/174) / [#166](https://github.com/ContextualWisdomLab/TEPP/issues/166) / [PR #287](https://github.com/ContextualWisdomLab/TEPP/pull/287) | `34e5da5f9f4d` | Land #287 only after exact-head checks and independent review; executable queue workers, OIDC/purpose enforcement, OpenTelemetry/SLOs, load/recovery, signed release/SBOM/provenance, assurance evidence, and support policy remain. |
...
| [#282](https://github.com/ContextualWisdomLab/TEPP/pull/282) | Fitted candidate-`K` topic selection plus folded #284–#286 topic-context and coverage work (GAP-004), stacked on #283 | Land #283 first, then rerun workflows on exact head `4edf666d1087` against main and obtain qualifying independent approval. |
