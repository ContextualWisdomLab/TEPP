...
- Snapshot facts were fetched live at 2026-08-28T07:23:31Z against protected
...
2026-08-28T07:23:31Z against protected main `b03cc378`. Review decisions,
...
| #281 | `05fce1433f3e1e255307451ce88b1cb1a0f0ab1c` | false | main | docs(gap): refresh protected-main and eight-PR queue |
| #282 | `4f5fee11621f367d47eeeceee27df8445c62cdde` | false | main | feat(topic): execute fitted candidate-K selection |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K`, topic-context artifact, draw-basis binding, and coverage repair are combined on the open #282 feature head through folded PRs #284–#286 | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [folded PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [folded PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) / [folded PR #286](https://github.com/ContextualWisdomLab/TEPP/pull/286) | `4f5fee11621f` | Land #282 only after its moved-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
...
| [#282](https://github.com/ContextualWisdomLab/TEPP/pull/282) | Fitted candidate-`K` topic selection plus folded #284–#286 topic-context and coverage work (GAP-004) | Complete restarted workflows on exact head `4f5fee11621f` and obtain qualifying independent approval. |
