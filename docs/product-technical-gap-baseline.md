...
- Snapshot facts were fetched live at 2026-08-28T11:45:21Z against protected
...
2026-08-28T11:45:21Z against protected main `b03cc378`. Review decisions,
...
| #281 | `d8bca6b8b4e4a98f636a0e066b7e063e6a049129` | false | main | docs(gap): refresh protected-main and nine-PR queue |
...
| #291 | `17a91ce5625e7a52f0d736e84b70a41864625d09` | false | agent/event-interval-consistency-170 | feat(event): persist interval consistency artifacts |
...
| GAP-007 | TDT detection/tracking and CHRONOS schema/forecast/temporal reasoning now compose on protected main, but interval consistency, persistence, and exports are not yet one calibrated operator workflow. | `partial` | product vertical | Versioned TDT/CHRONOS composition merged through [#269](https://github.com/ContextualWisdomLab/TEPP/pull/269) | [#170](https://github.com/ContextualWisdomLab/TEPP/issues/170) / [PR #279](https://github.com/ContextualWisdomLab/TEPP/pull/279) / [PR #291](https://github.com/ContextualWisdomLab/TEPP/pull/291) | `17a91ce5625e` | Land #279, then revalidate and land the dependent interval-artifact persistence slice #291; versioned JSON-LD/GraphML exports and known-truth workflow recovery remain. |
...
| [#291](https://github.com/ContextualWisdomLab/TEPP/pull/291) | Durable interval-consistency artifact persistence (GAP-007) | Validate exact head `17a91ce5625e`; land #279 first, then rebase and obtain qualifying independent approval. |
