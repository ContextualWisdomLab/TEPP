...
| Open pull requests | **103** | The queue is itself a release blocker and requires consolidation. |
| Draft pull requests | **34** | Most queued work is not independently review-ready. |
...
current 103-row volatile queue. Passing or queued Checks on an open PR never
...
| #164 | `cbceb6fee09535aeb5260d808a686b5d7e25cb77` | false | main | docs: define TEPP product completion and technical gap baseline |
