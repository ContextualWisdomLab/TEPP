...
- Snapshot facts were fetched live at 2026-08-28T04:19:39Z against protected
...
2026-08-28T04:19:39Z against protected main `b03cc378`. Review decisions,
...
| #281 | `8beec6fd21d7f51ff2de0835d807e8944fdda861` | false | main | docs(gap): refresh protected-main and eight-PR queue |
...
| #284 | `ad755893a4c391ddf2bd114744ea1b8752388106` | false | feat/topic-lineage-candidate-k | feat(topic): assemble context posterior artifact |
| #285 | `9698d5dbaba005c46cb2c7fcff527f54cb7b3993` | false | feat/topic-context-producer | fix(topic): bind artifact ids to fitted draw basis |
...
| GAP-004 | The central shared-latent temporal/relational topic estimator is absent. | `partial` | product vertical | CPU `f64` TRSL-TM reference estimator with ALR/ILR coordinates and refusal gates is implemented-main (v0.2.0 `topic_measurement`); fitted candidate-`K` execution and topic-context artifacts remain stacked open-branch candidates on #282/#284/#285 | [#167](https://github.com/ContextualWisdomLab/TEPP/issues/167) / [PR #282](https://github.com/ContextualWisdomLab/TEPP/pull/282) / [PR #284](https://github.com/ContextualWisdomLab/TEPP/pull/284) / [PR #285](https://github.com/ContextualWisdomLab/TEPP/pull/285) | `2858575ccc84` / `ad755893a4c3` / `9698d5dbaba0` | Synchronize the stack and land each PR only after its current-head checks and independent review; GPU, method effects, full Bayesian sampling, and topic birth/split/merge remain. This is not full #167 closure. |
