...
| Open pull requests | **98** | The queue is itself a release blocker and requires consolidation. |
...
current 98-row volatile queue. Passing or queued Checks on an open PR never
...
| #191 | `d894705147e5c2027ae2f581f458fe14d2551c7e` | false | agent/topic-logratio-coordinates | feat(topic): publish bounded TRSL topic lineage artifacts |
...
| #49 | `90b08bbe82cbe7776365a6c04df38857dfe5e53c` | false | main | feat(psychometric): posterior ESEM input gates with true-parameter RMSE |
| #48 | `e3373912891263d4f0c45625cc6312591120bf80` | false | main | feat(topic): logistic-normal ALR coordinates with true-parameter RMSE |
