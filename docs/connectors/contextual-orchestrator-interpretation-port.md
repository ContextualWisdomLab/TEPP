...
**Status:** Partial modular integration contract — `tepp_api::orchestrator_interpretation_exchange` and `tepp_api::bind_contextual_orchestrator` are the credential-free bindings; live HTTP remains accepted-target.
