...
**Status:** Partial — versioned DTO, HTTP interchange, and loopback live listener are implemented-main at protected head `c45be17a9dbce95ef81cee230e9d128abc7160ac`; production TLS/`$PORT` remaining
