...
- The weak/strong/strict labels remain conventional labels here. Meredith (1993) is the primary source for the hierarchy; its Cambridge Core original-paper page and abstract were opened, but no publicly accessible full-text copy was found among the checked sources. Unpaywall, OpenAlex, and Semantic Scholar were re-tried 2026-08-30T21:20Z (`is_oa: false`, `best_oa_location: null`, `isOpenAccess: false`, 0 locations; Internet Archive title+creator search returned 0 hits). Springer `content/pdf` for DOI 10.1007/BF02294825 redirected to the identity provider and did not yield a PDF; that stub is recorded separately from the public-access conclusion and does not assert that a subscription copy is unavailable. Putnick and Bornstein (2016) cite Meredith for residual invariance as part of *full factorial invariance*; that specific claim is not a reading of Meredith's full text.
