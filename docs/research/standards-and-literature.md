...
Allen, J. F. (1983). Maintaining knowledge about temporal intervals. *Communications of the ACM, 26*(11), 832–843. https://doi.org/10.1145/182.358434. Disjoint `before`/`after` relations inform `prediction_contradiction`; the crate does not implement Allen composition.
