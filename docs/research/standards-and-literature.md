...
## Privacy, purpose limitation, and re-identification

International Organization for Standardization and International Electrotechnical Commission. (2011). *Information technology—Security techniques—Privacy framework* (ISO/IEC Standard No. 29100:2011). Purpose specification and use limitation inform `identity_mapping`; they are not a certification claim.

International Organization for Standardization and International Electrotechnical Commission. (2018). *Privacy enhancing data de-identification terminology and classification of techniques* (ISO/IEC Standard No. 20889:2018). Re-identification is a privileged recovery of identity from de-identified data, not an analytical side effect.
