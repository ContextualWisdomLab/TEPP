...
an unbounded copy of protected data. It does **not** authorize writing
source text into operational logs, and it does not certify TEPP.

ISO/IEC 29100 treats data minimization as a privacy-engineering principle.
TEPP uses it to keep source text out of the log, not as a certification
claim.
