...
treats purpose specification and use limitation as distinct privacy
controls. They do **not** authorize substituting a global mask for
encryption, and they do not certify TEPP.
