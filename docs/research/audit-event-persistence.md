...
Audit rows remain distinct from reproducibility manifests: they record an
action against a subject identity, not a scientific digest triple
...
- a valid `revise` action renders `INSERT INTO audit_event`;
