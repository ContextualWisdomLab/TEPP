# Project-history stored-request GET (doctoring)

`GET /v1/project-histories/{idempotency_key}/request` returns one accepted
...
promotion are repository contract (ADR 0087; ADR 0014).
