"""Add PR 51 recovery, tolerance, and streamed-cardinality regressions."""

from pathlib import Path


CONTRACT = r'''//! VRAM budget, executable OOM retry, and CPU `f64` reference contracts.
...
use compute_backend::{
    ...
    VramController, VramProfile, WorkloadRequest, require_cpu_gpu_parity,
    streamed_weighted_sum,
};
...
path = Path("crates/compute_backend/tests/vram_budget_contract.rs")
