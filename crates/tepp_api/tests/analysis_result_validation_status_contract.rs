...
use tepp_api::{
    ...
    AnalysisRunRequest, AnalysisRunTerminalResult, AnalysisValidationStatus, ApiError,
};
...
#[test]
fn validated_success_round_trips_with_typed_status() {
    let summary = AnalysisResultSummary::new(
        "temporal_topic_measurement",
        120,
        42,
        AnalysisValidationStatus::Validated,
    )
...
fn non_verifiable_and_non_converged_cannot_deserialize_as_success() {
    let validated = AnalysisResultSummary::new(
        "temporal_topic_measurement",
        120,
        42,
        AnalysisValidationStatus::Validated,
