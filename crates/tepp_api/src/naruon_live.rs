...
use crate::analysis_run_retry_parent_http::{
    AnalysisRunRetryParent, analysis_run_retry_parent_path_run_id,
...
/// This port accepts versioned naruon POSTs and Naruon-only retry-parent GET.
#[derive(Debug)]
...
mod tests {
    ...
    #[test]
    #[allow(clippy::too_many_lines)]
    fn naruon_compatibility_listener_inspects_retry_parent_as_null() {
        use crate::{ANALYSIS_RUN_CONTRACT_VERSION, AnalysisRunRequest, AnalysisRunRetryParent};

        let run = AnalysisRunRequest {
            contract_version: ANALYSIS_RUN_CONTRACT_VERSION,
            idempotency_key: "naruon-parent-idem".into(),
            tenant_workspace_id: "naruon-parent-tenant".into(),
            snapshot_id: "naruon-parent-snapshot".into(),
        ...
        let inspect = format!(
            "GET /v1/analysis-runs/{run_id}/parent HTTP/1.1\r\nHost: 127.0.0.1\r\ncontent-type: application/json\r\ntepp-consumer: naruon\r\ntepp-contract-version: 1\r\ncontent-length: 0\r\n\r\n"
        );
        ...
        assert_eq!(parent.run_state, crate::AnalysisRunStatusState::Accepted);
        assert_eq!(parent.idempotency_key, run.idempotency_key);
        ...
        assert!(!inspected.body.contains("retried_from"));
        ...
        assert_eq!(
            service
                .handle_http_request(
                    "GET /v1/analysis-runs/missing/parent HTTP/1.1\r\nHost: 127.0.0.1\r\ncontent-type: application/json\r\ntepp-consumer: naruon\r\ntepp-contract-version: 1\r\ncontent-length: 0\r\n\r\n"
                )
                .status_code,
            400
        );
        ...
        assert_eq!(
            service
                .handle_http_request(&format!(
                    "POST /v1/analysis-runs/{run_id}/parent HTTP/1.1\r\nHost: 127.0.0.1\r\ncontent-type: application/json\r\ntepp-consumer: naruon\r\ntepp-contract-version: 1\r\nidempotency-key: naruon-parent-idem\r\ncontent-length: 0\r\n\r\n"
                ))
                .status_code,
            400
        );
        ...
        assert_eq!(
            service
                .handle_http_request(&format!(
                    "GET /v1/analysis-runs/{oversized}/parent HTTP/1.1\r\nHost: 127.0.0.1\r\ncontent-type: application/json\r\ntepp-consumer: naruon\r\ntepp-contract-version: 1\r\ncontent-length: 0\r\n\r\n"
                ))
                .status_code,
            413
        );
