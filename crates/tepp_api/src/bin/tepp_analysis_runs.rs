//! Operator CLI for loopback analysis-run collection GET and cancel POST.
...
use tepp_api::{
    ...
    AnalysisRunCollectionCliVerb, ApiError, execute_analysis_run_cancel_cli,
    execute_analysis_run_collection_cli, read_analysis_run_cancel_cli_stdin,
    read_analysis_run_collection_cli_stdin, render_analysis_run_cancel_cli_stdout,
