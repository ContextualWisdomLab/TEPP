//! Structural recovery-design failures never enter the numerical failure denominator.
...
use topic_measurement::{ReferenceTopicTrainingInput, SparseMatrix};
use uuid::Uuid;
...
fn six_term_training_input() -> ReferenceTopicTrainingInput {
