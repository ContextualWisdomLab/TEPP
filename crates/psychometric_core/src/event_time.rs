...
/// variance and is not extra TI. Unpublished `#308` is not a
/// dependency; the first-occasion observed extra is compared
/// inline. This is not a Kalman filter, not a matrix `expm`, not
/// DSEM, and not ctsem estimation.
///
/// # Errors
///
...
mod tests {
    ...
    fn asymptotic_time_independent_observed_variance_recovers_eq5_of_added_tipred_var() {
        // Driver et al. (2017, Eq. 5 of §7.2 addedTIPREDVAR;
        // Table 2, p. 12; 2017-era summary.ctsemFit.R): λ² (B/a)² v.
        // Form addedTIPREDVAR first, then (λ extra) λ with θ = 0.
        // JSS PDF re-opened 2026-08-30T14:06Z.
        let loading = 2.0_f64;
        ...
        // Eq. 5 of addedT0TIPREDVAR is λ² t0_b² v. Form inline so
        // unpublished #308 is not a dependency.
