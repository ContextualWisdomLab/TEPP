...
const COVERAGE_CALIBRATION_DESIGN_FINGERPRINT_DOMAIN: &[u8] =
    b"tepp.validation.coverage-calibration-design.v3\0";
...
/// lower and upper coverage bounds, and maximum accepted Monte Carlo standard
/// error. Floating-point criteria are encoded from their exact IEEE-754 binary64
/// bit patterns; integer/string lengths use explicit little-endian `u64` wire
/// geometry. The domain tag prevents reuse as another TEPP evidence digest.
///
