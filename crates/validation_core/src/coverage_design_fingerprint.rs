...
const COVERAGE_CALIBRATION_DESIGN_FINGERPRINT_DOMAIN: &[u8] =
    b"tepp.validation.coverage-calibration-design.v5\0";
...
/// the versioned empirical percentile estimator identity, and the lower/upper
/// percentile probabilities reported in durable calibration evidence. Floating-point
/// criteria are encoded from their exact IEEE-754 binary64 bit patterns; integer/string
...
/// owner-issued design/estimand/reporting-method identity lengths or attempted-
/// replication count as canonical `u64` wire values.
