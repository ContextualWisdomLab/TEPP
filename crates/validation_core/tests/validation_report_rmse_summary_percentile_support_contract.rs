...
fn monte_carlo_rmse_rejects_percentile_above_nonnegative_sample_sum_support() {
    ...
    // The generic signed carrier's moment support still admits this fixture.
    ...
    // The generic carrier cannot impose the nonnegative sample-sum bound because
    // it also summarizes signed metrics. The stronger support belongs to the typed
    // RMSE slot.
    ...
    let payload = r#"{"study_label":"rmse-summary-percentile-support","rmse":0.2,"rmse_standard_error":0.05,"mean_bias":0.0,"bias_standard_error":0.0,"interval_coverage":0.5,"coverage_wilson_lower":0.2,"coverage_wilson_upper":0.8,"temporal_order_accuracy":1.0,"monte_carlo_rmse":{"replication_count":4,"mean":1.0,"standard_deviation":2.0,"standard_error":1.0,"percentile_lower":0.0,"percentile_upper":4.1}}"#;
