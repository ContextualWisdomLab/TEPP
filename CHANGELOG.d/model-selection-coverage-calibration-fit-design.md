...
- `analysis_engine` now consumes this owner instead of reconstructing seeds and convergence controls locally. This change still does not execute or accept the scientific run; shard/final-evidence binding remains required before #680 scientific acceptance.
